...
# Template: app
# Command: /opt/Qt5.11.1/5.11.1/gcc_64/bin/qmake -o Makefile Vec3Tests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CXXFLAGS      = -pipe -std=c++1z -Wall -Wextra -g -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/local/include -I/opt/Qt5.11.1/5.11.1/gcc_64/include -I/opt/Qt5.11.1/5.11.1/gcc_64/include/QtGui -I/opt/Qt5.11.1/5.11.1/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = test1.0.0
DISTDIR = /home/s5009570/CGA/Workshop3/Vec3/.tmp/test1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/opt/Qt5.11.1/5.11.1/gcc_64/lib
...
Makefile: Vec3Tests.pro /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Vec3Tests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
moc_predefs.h: /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++1z -Wall -Wextra -g -g -Wall -W -dM -E -o moc_predefs.h /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/data/dummy.cpp
